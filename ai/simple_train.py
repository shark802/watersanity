#!/usr/bin/env python3
"""
Simple Training Script - Works with Demo Data
This script focuses on training models that work, regardless of database issues
"""
...
def create_realistic_demo_data():
    ...
    # Lower values with occasional spikes
...
def main():
    ...
    print("SIMPLE TRAINING (WORKS EVERY TIME)")
    print("=" * 50)
    ...
    print(f"   - Models saved to: sanitary/ai/")
